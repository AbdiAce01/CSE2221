...
public final class RSSReader {
    ...
    public static void main(String[] args) {
        ...
        /* if User enters an invalid rss feed. prompt user to add another */
        ...
        SimpleWriter file = new SimpleWriter1L(outputfile);

        outputHeader(channel, file); /* Opening Tags */
        int i = 0;
        ...
        outputFooter(file); /* Closing Tags */
