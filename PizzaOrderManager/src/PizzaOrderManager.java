...
public final class PizzaOrderManager {
    ...
    private static void getPriceMap(String fileName,
        ...
        /*
         * while (!file.atEOS()) { String str = file.nextLine();
         *
         * String first = ""; String second = "";
         *
         * for (int k = 0; k < str.length(); k++) { if (str.charAt(k) == ',') {
         * first = str.substring(0, k); second = str.substring(k + 1,
         * str.length()); } } int price = Integer.parseInt(second);
    ...
    private static int getOneOrder(SimpleReader input,
        ...
        /*
         * int total = 0; while (!input.atEOS()) { String str =
         * input.nextLine();
         *
         * if (sizePriceMap.hasKey(str)) { int price = sizePriceMap.value(str);
         * total += price; }
         *
         * String topping = input.nextLine();
         *
         * if (toppingPriceMap.hasKey(topping)) { int extra =
         * toppingPriceMap.value(topping); total += extra; }
         */
